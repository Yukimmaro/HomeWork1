package com.example.MyPhone.Contacts;
...
public class ContactsContent {
    ...
    private static Contact createDummyItem(int position) {
        return new Contact(100 + position, "Jotaro","Kujo","29.09.1999", "1", "123432543");
    }
    ...
    public static class Contact implements Parcelable {
        ...
        public Contact(int id, String name, String surname, String birthDate, String photoPath, String phoneNumber) {
            this.id = id;
            this.name = name;
